...
class Rss extends FrontendBaseBlock
{
    ...
    {
        $this->items = FrontendForumModel::getAll(30);
    ...
    {
        // get vars
        $title = (isset($this->settings['rss_title_' . FRONTEND_LANGUAGE])) ? $this->settings['rss_title_' . FRONTEND_LANGUAGE] : FrontendModel::getModuleSetting('Forum', 'rss_title_' . FRONTEND_LANGUAGE, SITE_DEFAULT_TITLE);
        $link = SITE_URL . FrontendNavigation::getURLForBlock('Forum');
        ...
        foreach ($this->items as $item) {
            ...
            // meta is wanted
            if (FrontendModel::getModuleSetting('Forum', 'rss_meta_' . FRONTEND_LANGUAGE, true)) {
                // append meta
