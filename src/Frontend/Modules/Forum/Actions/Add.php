...
use Frontend\Modules\Profiles\Engine\Authentication as FrontendProfilesProfile;
...
class Add extends FrontendBaseBlock
{
    ...
    private function loadForm()
    {
        ...
        $this->frm->addTextarea('text', null, null, null, true)->setAttributes(array('required' => null));
    }
    ...
    private function validateForm()
    {
        ...
        if($this->frm->isSubmitted()) {
        	...
        	$fields['text']->isFilled(FL::err('TextIsRequired'));
