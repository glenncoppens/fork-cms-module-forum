...
/**
 * This is the RSS-feed for comments on a certain post.
 *
 * @author Tijs Verkoyen <tijs@sumocoders.be>
 * @author Davy Hellemans <davy.hellemans@netlash.com>
 */
class PostCommentsRss extends FrontendBaseBlock
{
    /**
     * The record
     *
    ...
    private function getData()
    {
        ...
        // get posts
        $this->items = FrontendForumModel::getComments($this->record['id']);
    }
    ...
    private function parse()
    {
        ...
        $link = SITE_URL . FrontendNavigation::getURLForBlock('Forum', 'PostCommentsRss') .
                '/' . $this->record['url'];
        $detailLink = SITE_URL . FrontendNavigation::getURLForBlock('Forum', 'Detail');
        $description = null;
