...
<div class="pageTitle">
	<h2>{$lblModuleSettings|ucfirst}: {$lblForum}</h2>
</div>
...
{form:settings}
	<div class="box">
		...
		<div class="options">
			<label for="recentPostsFullNumberOfItems">{$msgNumItemsInRecentPostsFull|ucfirst}</label>
			{$ddmRecentPostsFullNumberOfItems} {$ddmRecentPostsFullNumberOfItemsError}
		</div>
		<div class="options">
			<label for="recentPostsListNumberOfItems">{$msgNumItemsInRecentPostsList|ucfirst}</label>
			{$ddmRecentPostsListNumberOfItems} {$ddmRecentPostsListNumberOfItemsError}
		</div>
	</div>
	...
	<div class="box">
		...
		<div class="options">
			...
			<ul class="inputList p0">
				<li><label for="pingServices">{$chkPingServices} {$lblPingForumServices|ucfirst}</label></li>
			</ul>
		</div>
	</div>
