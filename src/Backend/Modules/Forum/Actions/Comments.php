...
/**
 * This is the comments-action , it will display the overview of forum comments
 *
...
class Comments extends BackendBaseActionIndex
{
     ...
     * @param string $title The title for the forumpost.
     * @param string $URL The URL for the forumpost.
    ...
    {
        // reset URL
        $URL = BackendModel::getURLForBlock('Forum', 'Detail') . '/' . $URL . '#comment-' . $id;
    ...
    private function loadDataGrids()
    {
        ...
        $this->dgPublished = new BackendDataGridDB(
            BackendForumModel::QRY_DATAGRID_BROWSE_COMMENTS,
