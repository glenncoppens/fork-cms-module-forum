...
/**
 * This is the settings-action, it will display a form to set general forum settings
 *
...
class Settings extends BackendBaseActionEdit
{
    ...
    private function loadForm()
    {
        ...
        $this->frm->addDropdown(
            'recent_posts_full_number_of_items',
            array_combine(range(1, 10), range(1, 10)),
            BackendModel::getModuleSetting($this->URL->getModule(), 'recent_posts_full_num_items', 5)
        );
        $this->frm->addDropdown(
            'recent_posts_list_number_of_items',
            array_combine(range(1, 10), range(1, 10)),
            BackendModel::getModuleSetting($this->URL->getModule(), 'recent_posts_list_num_items', 5)
        );
    ...
    private function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                BackendModel::setModuleSetting($this->URL->getModule(), 'recent_posts_full_num_items', (int) $this->frm->getField('recent_posts_full_number_of_items')->getValue());
                BackendModel::setModuleSetting($this->URL->getModule(), 'recent_posts_list_num_items', (int) $this->frm->getField('recent_posts_list_number_of_items')->getValue());
