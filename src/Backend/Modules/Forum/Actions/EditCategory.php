...
class EditCategory extends BackendBaseActionEdit
{
    ...
    {
        $this->record = BackendForumModel::getCategory($this->id);
    }
    ...
    private function loadForm()
    {
        ...
        $this->meta->setUrlCallback('Backend\Modules\Forum\Engine\Model', 'getURLForCategory', array($this->record['id']));
    }
    ...
    protected function parse()
    {
        ...
        // delete allowed?
        $this->tpl->assign(
            'showForumDeleteCategory',
            BackendForumModel::deleteCategoryAllowed($this->id) && BackendModel::createURLForAction('DeleteCategory')
        );
    }
    ...
    private function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                // update the item
                BackendForumModel::updateCategory($item);
